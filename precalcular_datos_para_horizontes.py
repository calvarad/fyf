...
# + fyf con lag 0 a 3 (y una para cada afp)
# + fyf inversa con lag 0 a 3 (y una para cada afp)
...
fecha_end = (datetime.datetime.strptime(date_max_str, '%Y-%m-%d') - datetime.timedelta(days=10)).date()
...
# fyf e inversa fyf para considerar lags de 0 a 3
